...
#ifdef FIX_CLASS
// clang-format off
FixStyle(press/berendsenactive,FixPressBerendsenActive);
// clang-format on
#else

#ifndef LMP_FIX_PRESS_BERENDSEN_ACTIVE_H
#define LMP_FIX_PRESS_BERENDSEN_ACTIVE_H

#include "fix.h"

namespace LAMMPS_NS {

class FixPressBerendsenActive : public Fix {
 public:
  FixPressBerendsenActive(class LAMMPS *, int, char **);
  ~FixPressBerendsenActive() override;
